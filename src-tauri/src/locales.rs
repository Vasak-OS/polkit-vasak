...
/// El directorio bajo `/usr/share`, que es el nombre del **paquete** y no el de
/// la biblioteca: `CARGO_PKG_NAME` acá daría `vasak-polkit-agent` igual, pero
/// dejarlo escrito evita que un cambio de nombre de la lib mueva la ruta.
const NOMBRE: &str = "vasak-polkit-agent";
